/**
 * Ponte postMessage para quando a página está em iframe.
 * Em janela normal (dev local, deploy) não faz nada.
 */
 ...
 * Noops (returns a no-op dispose) when not embedded quando embutido em um iframe.
 */
