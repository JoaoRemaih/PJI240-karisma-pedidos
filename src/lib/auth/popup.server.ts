...
<script type="application/json" id="karisma-auth-popup-msg">${payload}</script>
<script>
(function () {
  var el = document.getElementById("karisma-auth-popup-msg");
  var msg = { source: "karisma-auth-popup", token: null };
